...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE tbcursos SET nmCursos='$nomeCurso', dsPublicoAlvo='$publicoAlvo', dsObjetivo='$dsObjetivo', vlCursos='$valorCurso' WHERE idCursos=$idCursos";
    $conexao->query($query);
    ...
    <div id="body">
        ...
        <form method="post" action="">
            ...
            <div class="form__group">
                <input type="text" class="form__input" name="nmCursos" placeholder="Nome do Curso" value="<?php echo $curso['nmCursos']; ?>" required>
                <label  class="form__label" for="nmCurso">Nome do Curso</label>

                <input type="text" class="form__input" name="dsPublicoAlvo" placeholder="Público Alvo" value="<?php echo $curso['dsPublicoAlvo']; ?>" required>
                <label  class="form__label" for="dsPublicoAlvo">Público Alvo</label>

                <input type="text" class="form__input" name="dsObjetivo" placeholder="Descrição Objetivo" value="<?php echo $curso['dsObjetivo']; ?>" required>
                <label  class="form__label" for="dsObjetivo">Descrição Objetivo</label>

                <input type="text" class="form__input" name="vlCursos" placeholder="Valor do Curso" value="<?php echo $curso['vlCursos']; ?>" required>
                <label  class="form__label" for="vlCurso">Valor do Curso</label>
