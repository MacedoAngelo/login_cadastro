    ...
    <div id="body">
        ...
        <form method="post" action="">
            ...
            <div class="form__group">
                <input type="text"class="form__input" name="nmCursos" placeholder="Nome do Curso" required>
                <label  class="form__label"for="nmCurso">Nome do Curso</label>

                <input type="text"class="form__input" name="dsPublicoAlvo" placeholder="Público Alvo" required>
                <label  class="form__label"for="dsPublicoAlvo">Público Alvo</label>

                <input type="text"class="form__input" name="dsObjetivo" placeholder="Descrição Objetivo" required>
                <label  class="form__label"for="dsObjetivo">Descrição Objetivo</label>

                <input type="text"class="form__input" name="vlCursos" placeholder="Valor do Curso" required>
                <label  class="form__label"for="vlCurso">Valor do Curso</label>

            </div>
            <br>
            <button class="button-19" role="button" type="submit">Criar</button>
