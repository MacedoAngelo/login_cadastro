...
$query = "SELECT * FROM tbcursos order by idCursos";
...
<body>
    <div id="body">
        ...
        <br><a href="create.php"><button class="button-19" role="button">Novo Curso</button></a>
        <!-- HTML !-->
                ...
                <table cellpadding="0" cellspacing="0" border="0">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 70px;">Deletar</th>
                        </tr>
                    </thead>
                </table>
            </div>
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td style=\"width:63px\"><a href='update.php?id=" . $row['idCursos'] . "'><img src=\"../imagens/edit.png\" alt=\"Ícone de Edição\" class=\"edit-icon\"></a></td>";
                                echo "<td style=\"width:63px\"><a href='delete.php?id=" . $row['idCursos'] . "'><img src=\"../imagens/del.png\" alt=\"Ícone de Deletar\" class=\"del-icon\"></a></td>";
                                echo "</tr>";
                            }
                        } else {
