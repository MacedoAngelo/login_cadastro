...
$query = "SELECT * FROM tbarea order by idArea";
...
<body>
    <div id="body">
        ...
        <br><a href="create.php"><button class="button-19" role="button">Nova Área</button></a>
        <!-- HTML !-->
                    ...
                    <tbody>
                        ...
                        if ($result->num_rows > 0) {
                            while ($row = $result->fetch_assoc()) {
                                ...
                                echo "<td style=\"width:63px\"><a href='update.php?id=" . $row['idArea'] . "'><img src=\"../imagens/edit.png\" alt=\"Ícone de Edição\" class=\"edit-icon\"></a></td>";
                                echo "<td style=\"width:63px\"><a href='delete.php?id=" . $row['idArea'] . "'><img src=\"../imagens/del.png\" alt=\"Ícone de Deletar\" class=\"del-icon\"></a></td>";
                                echo "</tr>";
                            }
                        } else {
